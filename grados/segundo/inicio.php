...
<div class="background-image">
  ...
  <div class="grid-container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <img src="../../imagenes/asignaturas/segundo_español.webp" alt="Descripción de la imagen">
                <h3>ESPAÑOL</h3>
                <p>GRADO: SEGUNDO</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <img src="../../imagenes/asignaturas/segundo_mate.webp" alt="Descripción de la imagen">
                <h3>MATEMÁTICAS</h3>
                <p>GRADO: SEGUNDO</p>
               <!-- <span>3% completado</span>-->
            </div>
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/segundo_ingles.webp" alt="Descripción de la imagen">    
            <h3>INGLÉS</h3>
            <p>GRADO: SEGUNDO</p>
               <!-- <span>3% completado</span>-->
            </div>
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/segundo_naturales.webp" alt="Descripción de la imagen">
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/segundo_sociales.webp" alt="Descripción de la imagen">
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/segundo_info.webp" alt="Descripción de la imagen">
                <h3>INFORMATICA</h3>
                <p>GRADO: SEGUNDO</p>
               <!-- <span>3% completado</span>-->
            </div>
