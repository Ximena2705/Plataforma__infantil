...
<div class="background-image">
    ...
    <h3 class="titulo-grado" id="titulo" >Grado: Tercero</h3>  
  <!-- Aquí colocamos la imagen dentro de un contenedor -->
  <div class="grid-container">
        <!-- Tarjeta de ejemplo -->
        <div class="card">
            <div class="card-header" style="background-image: url('pattern1.jpg');"></div>
            <div class="card-body">
                <img src="../../imagenes/asignaturas/tercero_español.webp" alt="Descripción de la imagen">
                <h3>ESPAÑOL</h3>
                <p>GRADO: TERCERO</p>
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
                <img src="../../imagenes/asignaturas/tercero_mate.webp" alt="Descripción de la imagen">
                <h3>MATEMÁTICAS</h3>
                <p>GRADO: TERCERO</p>
               <!-- <span>3% completado</span>-->
            </div>
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/tercero_ingles.webp" alt="Descripción de la imagen">    
            <h3>INGLÉS</h3>
            <p>GRADO: TERCERO</p>
               <!-- <span>3% completado</span>-->
            </div>
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/tercero_naturales.webp" alt="Descripción de la imagen">
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/tercero_sociales.webp" alt="Descripción de la imagen">
        ...
        <div class="card">
            <div class="card-header" style="background-image: url('pattern2.jpg');"></div>
            <div class="card-body">
            <img src="../../imagenes/asignaturas/tercero_info.webp" alt="Descripción de la imagen">
                <h3>INFORMATICA</h3>
                <p>GRADO: TERCERO</p>
               <!-- <span>3% completado</span>-->
            </div>
